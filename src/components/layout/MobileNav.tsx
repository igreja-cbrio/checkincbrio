...
export function MobileNav() {
  const { isLeader, isAdmin, signOut } = useAuth();
...
export function MobileHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 safe-top">
